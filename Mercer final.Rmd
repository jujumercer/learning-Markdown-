...
# Presentation
Function: Comparing the mitochondrial nucleotide sequences of tigre (Panthera tigris) and jaguar (Panthera onca). 
>First step will be to search dataframes with the nucleotide sequence for both species, in NCBI  (https://www.ncbi.nlm.nih.gov/).

# Functions Creating
Finding similarities among mitochondrial nucleotide sequences among the 2 species Panthera tigris and Panthera onca. 
1. In NCBI search for fasta files of mitochondrial sequence for both species and I saved the fasta format at the c:desktop/bioinformatica/
